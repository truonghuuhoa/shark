...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row">
		...
		<input type="password" class="form-control woocommerce-Input--text input-text" name="password_1" id="password_1" autocomplete="new-password" />
	</p>
	<p class="woocommerce-form-row woocommerce-form-row--last form-row">
		...
		<input type="password" class="form-control woocommerce-Input--text input-text" name="password_2" id="password_2" autocomplete="new-password" />
	</p>
	...
	<p class="woocommerce-form-row form-row text-center">
		...
		<button type="submit" class="btn btn-success" value="<?php esc_attr_e( 'Update', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
	</p>
