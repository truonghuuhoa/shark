...
if ( class_exists( 'FCMS_WAS_Core_Cross_Sells' ) ) {
	return;
}

/**
 * FCMS_WAS_Core_Cross_Sells.
 *
 * @class    FCMS_WAS_Core_Cross_Sells
 * @version  1.0.0
 */
class FCMS_WAS_Core_Cross_Sells {
	/**
	 * Single instance of the FCMS_WAS_Core_Licence object.
	 *
	 * @var FCMS_WAS_Core_Licence
	 */
	...
	/**
	 * Creates/returns the single instance FCMS_WAS_Core_Licence object.
	 *
	 * @param array $args Arguments.
	 *
	 * @return FCMS_WAS_Core_Licence
	 */
	...
	private static function get_plugins() {
		$transient_name = 'fcms_get_plugins';
		...
		$request = wp_remote_get( 'https://fcmswp.com/wp-json/wp/v2/cpt_product?per_page=100' );
	...
	private static function get_plugin() {
		$class_name = substr( 'FCMS_WAS_', 0, -1 );
