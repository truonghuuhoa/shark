...
if ( class_exists( 'FCMS_WAS_Core_Settings' ) ) {
	return;
}

/**
 * FCMS_WAS_Core_Settings.
 *
 * @class    FCMS_WAS_Core_Settings
 * @version  1.0.6
 */
class FCMS_WAS_Core_Settings {
	/**
	 * Single instance of the FCMS_WAS_Core_Settings object.
	 *
	 * @var FCMS_WAS_Core_Settings
	 */
	 ...
	 *
	 * @var FCMS_WAS_Settings_Framework
	 */
	...
	/**
	 * Creates/returns the single instance FCMS_WAS_Core_Settings object.
	 *
	 * @param array $args Arguments.
	 *
	 * @return FCMS_WAS_Core_Settings
	 */
	...
	public static function init() {
		...
		self::$settings_framework = new FCMS_WAS_Settings_Framework( self::$args['settings_path'], self::$args['option_group'] );
	...
	public static function add_settings_page() {
		$default_title = sprintf( '<div style="height: 28px; line-height: 28px;"><img width="24" height="28" style="display: inline-block; vertical-align: middle; margin: 0 8px 0 0" src="%s"> %s</div>', esc_attr( self::$fcms_svg ), self::$args['title'] );
