...
if ( ! class_exists( 'FCMS_WooThumbs_Settings_Framework' ) ) {
	/**
	 * FCMS_WooThumbs_Settings_Framework class
	 */
	class FCMS_WooThumbs_Settings_Framework {
		/**
		 * @access private
		 * @var array
		 */
		...
		/**
		 * FCMS_WooThumbs_Settings_Framework constructor.
		 *
