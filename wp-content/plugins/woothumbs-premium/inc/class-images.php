...
/**
 * FCMS_WooThumbs_Images.
 *
 * @class    FCMS_WooThumbs_Images
 * @version  1.0.0
...
class FCMS_WooThumbs_Images {
	...
	public static function get_image_width( $size = 'single' ) {
		$woothumbs_settings = get_option( 'fcms_woothumbs_settings' );
	...
	public static function get_attachment_props( $attachment_id, $product_id = null ) {
		...
		// Large version.
		$large_size                       = $fcms_woothumbs_class->settings['display_images_large_image_size'];
