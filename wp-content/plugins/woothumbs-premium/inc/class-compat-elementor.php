 ...
 * @since 4.6.11
 */
class FCMS_WooThumbs_Compat_Elementor {
	/**
	 * Run.
	 */
	...
	public static function disable_auto_woothumbs() {
		...
		remove_action( 'woocommerce_before_single_product_summary', array( $fcms_woothumbs_class, 'show_product_images' ), 20 );
	}
	...
	public static function modify_product_gallery_component_settings( $element, $args ) {
		...
		$element->add_control(
			'fcms_woothumbs_style_warning',
			array(
				'type'            => Elementor\Controls_Manager::RAW_HTML,
				/* translators: %s is the link to WooThumbs settings page. */
				'raw'             => sprintf( __( 'This element is styled by WooThumbs. Go to the <a href="%s" target="_blank">settings page</a> to customise the product gallery.', 'fcms-woothumbs' ), esc_url( admin_url( 'admin.php?page=fcms-woothumbs-settings' ) ) ),
