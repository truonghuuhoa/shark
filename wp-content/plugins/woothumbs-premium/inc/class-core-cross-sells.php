...
if ( class_exists( 'FCMS_WooThumbs_Core_Cross_Sells' ) ) {
	return;
}

/**
 * FCMS_WooThumbs_Core_Cross_Sells.
 *
 * @class    FCMS_WooThumbs_Core_Cross_Sells
 * @version  1.0.0
 */
class FCMS_WooThumbs_Core_Cross_Sells {
	/**
	...
	/**
	 * Creates/returns the single instance  object.
	 *
	...
	private static function get_plugin() {
		$class_name = substr( 'FCMS_WooThumbs_', 0, -1 );
